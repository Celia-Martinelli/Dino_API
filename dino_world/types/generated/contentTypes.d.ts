...
export interface ApiDietDiet extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::diet.diet', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::diet.diet', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}

export interface ApiDinosaurDinosaur extends Schema.CollectionType {
  ...
  attributes: {
    ...
    continent: Attribute.Relation<
      ...
      'api::continent.continent'
    >;
    prey: Attribute.Relation<
      'api::dinosaur.dinosaur',
      'manyToMany',
      'api::dinosaur.dinosaur'
    >;
    predators: Attribute.Relation<
      'api::dinosaur.dinosaur',
      'manyToMany',
      'api::dinosaur.dinosaur'
    >;
    ...
    family: Attribute.Relation<
      ...
      'api::family.family'
    >;
    walks: Attribute.Relation<
      'api::dinosaur.dinosaur',
      'manyToMany',
      'api::walk.walk'
    >;
    museums: Attribute.Relation<
      'api::dinosaur.dinosaur',
      'manyToMany',
      'api::museum.museum'
    >;
...
export interface ApiEraEra extends Schema.CollectionType {
  ...
  attributes: {
    ...
    dinosaurs: Attribute.Relation<
      ...
      'api::dinosaur.dinosaur'
    >;
    beginning: Attribute.String;
    finished: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiWalkWalk extends Schema.CollectionType {
  ...
  attributes: {
    ...
    dinosaurs: Attribute.Relation<
      ...
      'api::dinosaur.dinosaur'
    >;
    number_of_members: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::walk.walk', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::walk.walk', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::dinosaur.dinosaur': ApiDinosaurDinosaur;
